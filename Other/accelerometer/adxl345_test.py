...
while True:
    ...
    #print('X={0}, Y={1}, Z={2} in G'.format(x, y, z))

    x, y, z = [r*SCALE_MULTIPLIER*EARTH_GRAVITY_MS2 for r in accel.read()]
    print('X={0:.2f}, Y={1:.2f}, Z={2:.2f} in m/s^2'.format(x, y, z))
